...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `☁️ sebas-md`, dev, 'argumedod44@gmail.com', `🇨🇴 Colombia`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Una Bot 🤍`, `${packname}`, `📵 No Hacer Spam`, 'thatanjirobot@gmail.com', `ar argentina`, `https://github.com/sebas-mod/Tanjiro-bot`, biobot]
], m)
