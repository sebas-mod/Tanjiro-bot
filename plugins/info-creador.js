...
let biografia = await conn.fetchStatus('5491140951814' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `☁️ sebas-md`, dev, 'argumedod44@gmail.com', `argentina`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Una Bot 🤍`, `${packname}`, `📵 No Hacer Spam`, `argentina`, `https://github.com/sebas-mod/Tanjiro-bot`, biobot]
], m)
