...
if (!text) return m.reply(*Hola cómo estas 😊, En que te puedo ayudar?*, ingrese una petición o orden para usar la función de chagpt\n*Ejemplo:*\n${usedPrefix + command} Recomienda un top 10 de películas de acción) 
let syst = Actuaras como un Bot de WhatsApp el cual fue creado por elrebelde, tu seras tanjirobot.
